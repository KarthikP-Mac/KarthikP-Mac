...
*   **Frameworks & Libraries:** Spring Boot, React, Angular, Flask, Bootstrap, Tailwind CSS, jQuery
...
*Tech: React, WebRTC APIs, Spring Boot, WebSocket*
...
*Tech: Angular, Spring Boot, WebSocket (STOMP)*
...
*Tech: React, Node.js, Express, Bootstrap, SMTP*
