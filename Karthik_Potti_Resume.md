...
*   **Frameworks & Libraries:** Spring Boot, React, Angular, Flask, Django, Bootstrap, Tailwind CSS, jQuery
...
*   **Tools & Platforms:** Git, GitHub, Linux (WinSCP), Maven, Postman, Vercel, Render
...
*Tech: Python, Streamlit, LangChain, FAISS, Hugging Face Embeddings, Groq/Gemini/OpenAI/Claude*
...
*   Built a robust Retrieval-Augmented Generation (RAG) pipeline utilizing custom recursive text splitters and FAISS vector database.

### **Real-Time Web Applications**

#### **Web-RTC (Live Random Video Calls) [Public]**
*Tech: React, WebRTC APIs, Node.js, Socket.io*
...
*Tech: Spring Boot, WebSocket (STOMP), React*
...
*   Contributed to the full stack development of an institute portal. Designed responsive interfaces in React (Frontend) and created robust services in Express/Node (Backend) to handle courses, student registrations, and announcements.
...
#### **Python-Pdf**
*Tech: Python, Tkinter, PyPDF2, pdfplumber*
*   Built a desktop utility for batch PDF creation via folder selection, extracting text content, and exporting embedded images.
